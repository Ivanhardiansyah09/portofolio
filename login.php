<?php
// Proses login dan validasi akan berada di sini

// Contoh validasi sederhana, biasanya menggunakan database
if ($_POST['email'] == 'user@example.com' && $_POST['pswd'] == 'password') {
    // Jika login berhasil, redirect ke halaman utama (home)
    ...
    <div class="main">       
        ...
        <div class="login">
            <form action="Portfolio.html" method="POST">
                <a href="http://127.0.0.1:5500/portofolio/login.html"></a>
